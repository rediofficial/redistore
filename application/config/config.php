...
|
*/
$config['base_url'] = 'http://localhost/redi_store/';
...
$config['sess_expiration'] = 1800; // 30 menit (1800 detik)
$config['sess_time_to_update'] = 300; // waktu untuk memperbarui session id
