...
<head>
    ...
    <style>
        ...
        .content {
            margin-left: 220px; /* Adjusted margin to make room for sidebar */
            padding: 20px;
        }
        .order-history {
            margin-top: 20px;
                        ...
                        <tbody>
                            <?php foreach ($transaksi as $pesanan): ?>
                                <tr>
                                    ...
                                    <td>
                                        <form action="<?php echo site_url('seller/detail'); ?>" method="get">
                                    ...
                                    <td>
                                        <form action="<?php echo base_url('seller/update_status'); ?>" method="post">
