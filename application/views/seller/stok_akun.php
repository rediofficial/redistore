        ...
        <?php foreach ($akun_ml as $account): ?>
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <?php else: ?>
                        <form action="<?php echo base_url('seller/detail_akun'); ?>" method="post">
                        <input type="hidden" name="kode_akun" value="<?php echo $account['kode_akun']; ?>">
                        <button type="submit" class="btn-buy">Ready</button>
                    </form>
                    <?php endif; ?>
                </div>
            </div>
